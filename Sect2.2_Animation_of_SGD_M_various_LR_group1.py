...
def main():
    ...
    nframes = max([WaTraces_SGD_MOMENTUM1.size, WaTraces_SGD_MOMENTUM2.size, WaTraces_SGD_MOMENTUM3.size, WaTraces_SGD_MOMENTUM4.size, WaTraces_SGD_MOMENTUM5.size])
    epoch1, epoch2, epoch3, epoch4, epoch5 = EpochTraces1[-1]+1, EpochTraces2[-1]+1, EpochTraces3[-1]+1, EpochTraces4[-1] + 1, EpochTraces5[-1]+1
    ...
    line_SGD_MOMENTUM1, = ax.plot([], [], '-r', lw=2, label='SGD_Momentum epoch={} '.format(epoch1)+lr_SGD_MOMENTUM1)

    walist_SGD_MOMENTUM2 = []
    wblist_SGD_MOMENTUM2 = []
    point_SGD_MOMENTUM2, = ax.plot([], [], 'yo', lw=0.5, markersize=4)
    line_SGD_MOMENTUM2, = ax.plot([], [], '-y', lw=2, label='SGD_Momentum epoch={} '.format(epoch2)+lr_SGD_MOMENTUM2)

    walist_SGD_MOMENTUM3 = []
    wblist_SGD_MOMENTUM3 = []
    point_SGD_MOMENTUM3, = ax.plot([], [], 'mo', lw=0.5, markersize=4)
    line_SGD_MOMENTUM3, = ax.plot([], [], '-m', lw=2, label='SGD_Momentum epoch={} '.format(epoch3)+lr_SGD_MOMENTUM3)

    walist_SGD_MOMENTUM4 = []
    wblist_SGD_MOMENTUM4 = []
    point_SGD_MOMENTUM4, = ax.plot([], [], 'go', lw=0.5, markersize=4)
    line_SGD_MOMENTUM4, = ax.plot([], [], '-g', lw=2, label='SGD_Momentum epoch={} '.format(epoch4)+lr_SGD_MOMENTUM4)

    walist_SGD_MOMENTUM5 = []
    wblist_SGD_MOMENTUM5 = []
    point_SGD_MOMENTUM5, = ax.plot([], [], 'o', lw=0.5, markersize=4, color='aqua')
    line_SGD_MOMENTUM5, = ax.plot([], [], '-', lw=2, color='aqua', label='SGD_Momentum epoch={} '.format(epoch5)+lr_SGD_MOMENTUM5)
    ...
    def animate(i):
        ...
        wa_SGD_MOMENTUM5, wb_SGD_MOMENTUM5 = WaTraces_SGD_MOMENTUM5[i], WbTraces_SGD_MOMENTUM5[i]
    ...
    anim.save('Results/Part5_Fig9_Animation_SGD_Momentum_100Epoch_VariousLR.mp4', fps=30, bitrate=1800)
