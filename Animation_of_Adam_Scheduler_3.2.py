...
def main():
    ...
    WaTraces_Adam3, WbTraces_Adam3, LossTraces_Adam3, EpochTraces3, minibatchTraces3, updateTraces3,  lr_Adam3, gamma_Adam3, method_Adam3, \
        ...
        read_optimizer_results(r'results/Adam_lr0.12_Epoch100_Schl0.80_results.log')
    WaTraces_Adam4, WbTraces_Adam4, LossTraces_Adam4, EpochTraces4, minibatchTraces4, updateTraces4,  lr_Adam4, gamma_Adam4, method_Adam4, \
        ...
        read_optimizer_results(r'results/Adam_lr0.12_Epoch100_Schl0.50_results.log')
    ...
    ax.set_title('Adam Optimization with MultiStepLR Schedulers using Milestones', fontsize=16)
    plt.xlabel("Wa")
    plt.ylabel("Wb")
    ...
    line_Adam3, = ax.plot([], [], '-m', lw=1, label='Adam epoch={}, '.format(epoch3)+lr_Adam3+' MultiStepLR w/ gamma=0.8')

    walist_Adam4 = []
    wblist_Adam4 = []
    point_Adam4, = ax.plot([], [], 'o', lw=0.5, markersize=4, color='aqua')
    line_Adam4, = ax.plot([], [], '-', lw=1, color='aqua', label='Adam epoch={}, '.format(epoch4)+lr_Adam4+' MultiStepLR w/ gamma=0.5')
